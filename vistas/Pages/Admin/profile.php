...
<body>
  ...
  <?php if ($dato->num_rows > 0) {
    ...
    <div class="motivation">
      <img src="../../../Assets/images/businessman.png" alt="Sticker">
      <div class="frase">
        <h2>Hola jefe, cada dia hay mejores resultados</h2>
        <p>¿Necesita algunos datos?</p>
      </div>
    </div>
    <div class="profile">
      <img src="../../../Assets/images/iconos/Perfil_adm.jpeg" alt="Foto de perfil">
